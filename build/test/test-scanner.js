...
mocha_1.describe('scanner', () => {
    mocha_1.describe('scan', () => {
        mocha_1.it('should complain when called without a path', done => {
            // TODO: The second argument must be a string.  Fix that.
            scanner.scan(null, /.js$/).catch(() => {
                done();
            });
        });
        mocha_1.it('should error when called on a bad path', done => {
            // TODO: Determine if the err parameter should be used.
            scanner.scan('./this directory does not exist', /.js$/).catch(() => {
                done();
            });
        });
        mocha_1.it('should ignore broken links', function (done) {
        ...
        mocha_1.it('should be able to return all file stats directly', done => {
        ...
        mocha_1.it('should be able to filter to return all file stats', done => {
            scanner.scan(fixture('coffee'), COFFEE_FILES_REGEX).then(fileStats => {
        ...
        mocha_1.it('should be able to filter filenames', done => {
        ...
        mocha_1.it('should be able to filter file stats', done => {
            scanner.scan(fixture('coffee'), /.*$/).then(fileStats => {
        ...
        mocha_1.it("should return the same hash if the files don't change", done => {
        ...
        mocha_1.it('should return precomputed hash', done => {
        ...
        mocha_1.it('should work with relative paths', done => {
        ...
        mocha_1.it('should return a valid hash even when there are no javascript files', done => {
        ...
        mocha_1.it('should return a different hash if the files contents change', done => {
        ...
        mocha_1.it('should return an updated file list when file list changes', done => {
            scanner.scan(fixtureDir, /.js$/).then(fileStats1 => {
                const files1 = Object.keys(fileStats1.all());
                assert.ok(fileStats1.hash);
    ...
    mocha_1.describe('on errors', () => {
        ...
        mocha_1.before(() => {
            mockedScanner = proxyquire('../src/agent/io/scanner', {
                findit2: (dir) => {
                    ...
                    throw new Error("'findit' should have been called with " +
                ...
                fs: {
                    createReadStream: (filename) => {
                        ...
                        setImmediate(() => {
                            ...
                            assert.ok(found, `The file ${filename} should not be read ` +
        ...
        mocha_1.it('should report errors on files that cannot be read', async () => {
