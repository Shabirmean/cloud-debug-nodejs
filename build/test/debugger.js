...
class Debugger extends common_1.ServiceObject {
    /**
     * @constructor
     */
    constructor(debug) {
     ...
     */
    async listDebuggees(projectId, includeInactive) {
        return new Promise((resolve, reject) => {
            ...
            this.request({ uri, json: true }, (err, body, response) => {
                if (err) {
                    ...
                    reject(new Error('unable to list debuggees, status code ' + response.statusCode));
                }
                else if (!body) {
     ...
     *     object if an error occurred in obtaining it.
     */
    listBreakpoints(debuggeeId, options) {
        return new Promise((resolve, reject) => {
            ...
            this.request({ uri, json: true }, (err, body, response) => {
                if (err) {
                    ...
                    reject(new Error('unable to list breakpoints, status code ' + response.statusCode));
                }
                else if (!body) {
                    reject(new Error('invalid response body from server'));
                }
     ...
     */
    getBreakpoint(debuggeeId, breakpointId) {
        return new Promise((resolve, reject) => {
            ...
            this.request({ uri, json: true }, (err, body, response) => {
                if (err) {
                    ...
                    reject(new Error('unable to get breakpoint info, status code ' +
                        response.statusCode));
                }
     ...
     */
    setBreakpoint(debuggeeId, breakpoint) {
        return new Promise((resolve, reject) => {
            const query = { clientVersion: this.clientVersion };
            const options = {
                uri: API +
            ...
            this.request(options, (err, body, response) => {
                if (err) {
                    ...
                    reject(new Error('unable to set breakpoint, status code ' + response.statusCode));
                }
                else if (!body || !body.breakpoint) {
                    reject(new Error('invalid response body from server'));
                }
        ...
        return new Promise((resolve, reject) => {
            ...
            this.request(options, (err, body, response) => {
                if (err) {
                    ...
                    reject(new Error('unable to delete breakpoint, status code ' + response.statusCode));
                }
